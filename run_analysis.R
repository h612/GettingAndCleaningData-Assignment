...
tdata<-allData %>%                                        # Specify data frame
  group_by(subject, activity) %>%                         # Specify group indicator
  summarise_all(funs(mean))

View(tdata)
write.table(tdata, "./R/UCI HAR Dataset/tidy.txt", row.names = FALSE, quote = FALSE)
